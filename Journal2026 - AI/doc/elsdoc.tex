...
\includeclip{1}{130 612 477 707}{utils/1psingleauthorgroup.pdf}%%{elstest-1p.pdf}%single author group
...
\includeclip{1}{93 135 499 255}{utils/1pseperateaug.pdf}%%{elstest-1p.pdf}%single author group
\def\rulecolor{orange}
...
\def\rulecolor{blue!70}
\src{Header of the title page..}
\includeclip{1}{119 563 468 709}{utils/1pseperateaug.pdf}%%{elstest-1p.pdf}%seperate author groups
\def\rulecolor{orange}
%\pagebreak
...
\includeclip{1}{124 567 477 670}{utils/elstest-1pdoubleblind.pdf}%%{elstest-1p.pdf}%single author group%%doubleblind
\def\rulecolor{orange}
...
\includeclip{2}{1 1 453 120}{utils/jfigs.pdf}
\def\rulecolor{orange}
...
\includeclip{1}{1 1 453 105}{utils/jfigs.pdf}
\def\rulecolor{orange}
...
\includeclip{3}{1 1 453 65}{utils/jfigs.pdf}
\def\rulecolor{orange}
...
\def\rulecolor{blue!70}
\src{List -- Enumerate}
\includeclip{4}{1 1 453 185}{utils/jfigs.pdf}
\def\rulecolor{orange}
...
\def\rulecolor{blue!70}
\src{List -- enhanced}
\includeclip{5}{1 1 313 83}{utils/jfigs.pdf}
\def\rulecolor{orange}
...
\includeclip{4}{105 500 500 700}{utils/1psingleauthorgroup.pdf}
\def\rulecolor{orange}
...
\includeclip{3}{59 421 532 635}{utils/elstest-3pd.pdf}
\def\rulecolor{orange}
\vspace*{6pt}
...
\src{}\hypertarget{sc}{}
\def\rulecolor{blue!70}
\hyperlink{bsc}{\includeclip{1}{88 120 514 724}{utils/elstest-1p.pdf}}
\def\rulecolor{orange}

\src{}\hypertarget{dc}{}
\def\rulecolor{blue!70}
\hyperlink{bsc}{\includeclip{1}{27 61 562 758}{utils/elstest-5p.pdf}}
\def\rulecolor{orange}
